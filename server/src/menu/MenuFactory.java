...
public final class MenuFactory {
   ...
   public static Menu getStartMenu() {
      if (StartMenu == null) {
         ...
         StartMenu = new Menu(MenuName.START_MENU,
               new Option[] { start, leaderboard, parameters, help, quit });
   ...
   private static Menu getGameModesMenu() {
      if (GameModesMenu == null) {
         ...
         GameModesMenu = new Menu(MenuName.GAMES_MODE_MENU,
               new Option[] { classic, golden, rush, back });
   ...
   static Menu getParametersMenu() {
      if (ParametersMenu == null) {
         ...
         ParametersMenu = new Menu(MenuName.PARAMETERS_MENU,
               new Option[] { difficulty, back });
   ...
   private static Menu getDifficultyMenu() {
      if (DifficultyMenu == null) {
         Option beginner = new Option(1,
               GameUtil.captitalize(Difficulty.BEGINNER.value));
         Option easy = new Option(2,
               GameUtil.captitalize(Difficulty.EASY.value));
         Option amateur = new Option(3,
               GameUtil.captitalize(Difficulty.AMATEUR.value));
         Option normal = new Option(4,
               GameUtil.captitalize(Difficulty.NORMAL.value));
         Option hard = new Option(5,
               GameUtil.captitalize(Difficulty.HARD.value));
         Option hardcore = new Option(6,
               GameUtil.captitalize(Difficulty.HARDCORE.value));
         Option back = new Option(7, "Retour");

         DifficultyMenu = new Menu(MenuName.DIFFICULTY_MENU,
               new Option[] { beginner, easy, amateur, normal, hard, hardcore,
                     back });
   ...
   public static Menu getHelpMenu() {
      if (HelpMenu == null) {
         ...
         HelpMenu = new Menu(MenuName.HELP_MENU,
               new Option[] { modes, difficulties, back });
   ...
   public static Menu getHelpModesMenu() {
      if (HelpModesMenu == null) {
         ...
         HelpModesMenu = new Menu(MenuName.HELP_MODES_MENU,
               new Option[] { classic, golden, rush, back });
   ...
   public static Menu getEndMenu() {
      if (EndMenu == null) {
         ...
         EndMenu = new Menu(MenuName.END_MENU,
               new Option[] { startMenu, replay, quit });
